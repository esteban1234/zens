...
<div class="banners">
  <div class="fondo">
    <p class="tits">NUESTROS SERVICIOS</p>
    <p class="subtit">El mercado cada vez es más exigente y nosotros te ofrecemos los mejores servicios en publicidad para que tu empresa luzca diferente de la competencia.</p>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <p class=" texto">
              ...
              <i style="color: #72103D" class="fa fa-star-half-o" aria-hidden="true"></i> Activaciones<br>
              <i style="color: #72103D" class="fa fa-star-half-o" aria-hidden="true"></i> ATL Y BTL</p>
          </div>
        </div> <br><br>
        <div class="row">
          <div class="col-md-4">
